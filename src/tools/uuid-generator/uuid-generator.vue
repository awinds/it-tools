    ...
    <div v-if="version === 'v3' || version === 'v5'">
      <div>
        <c-buttons-select
          ...
          :label="t('tools.token-generator.namespace')"
          label-width="100px"
          mb-2
        />
      </div>
      <div flex-1>
        <c-input-text
          v-model:value="v35Args.namespace"
          :placeholder="t('tools.token-generator.namespace')"
          label-width="100px"
          label-position="left"
          label=" "
      ...
      <c-input-text
        ...
        :placeholder="t('tools.token-generator.name')"
        :label="t('tools.token-generator.name')"
        label-width="100px"
        label-position="left"
        mb-2
      />
