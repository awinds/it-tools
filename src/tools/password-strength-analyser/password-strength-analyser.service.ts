...
function getHumanFriendlyDuration({ seconds }: { seconds: number }) {
  ...
  const timeUnits = [
    { unit: 'millenium', secondsInUnit: 31536000000, format: prettifyExponentialNotation, plural: '千年' },
    { unit: 'century', secondsInUnit: 3153600000, plural: '百年' },
    { unit: 'decade', secondsInUnit: 315360000, plural: '十年' },
    { unit: 'year', secondsInUnit: 31536000, plural: '年' },
    { unit: 'month', secondsInUnit: 2592000, plural: '月' },
